...
public class JWTUtil {
    private static byte[] obtenerSecreto() {
        byte[] firma = new byte[] {
            (byte)214,(byte)316,
            ...
            (byte)44,(byte)55,(byte)65,(byte)73,(byte)33,(byte)16,(byte)98,(byte)76
        };
        return firma;
    }
    ...
    public static String crearJWT(String usuario) {
        ...
        String jwt = Jwts
                .builder()
                .signWith(SignatureAlgorithm.HS256, obtenerSecreto())
